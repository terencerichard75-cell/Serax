...
:root {
  ...
  --white: #fdfaf6;
  --nav-h: 54px; --top-h: 36px; --ann-h: 36px;
}
...
/* ANNOUNCE */
.announce { background: var(--ink); color: var(--cream); text-align: center; font-size: 10.5px; letter-spacing: 0.2em; text-transform: uppercase; padding: 9px 20px; font-weight: 400; }
.announce em { color: var(--sand); font-style: normal; }

/* TOPBAR */
.topbar { height: var(--top-h); background: var(--cream-mid); border-bottom: 1px solid var(--sand-light); display: flex; align-items: center; justify-content: flex-end; padding: 0 48px; gap: 28px; }
.topbar-item { font-size: 10px; letter-spacing: 0.16em; text-transform: uppercase; color: var(--ink-muted); text-decoration: none; cursor: pointer; transition: color 0.2s; display: flex; align-items: center; gap: 5px; }
...
.navbar { height: var(--nav-h); background: var(--cream-mid); border-bottom: 1px solid var(--sand-light); display: grid; grid-template-columns: 1fr auto 1fr; align-items: center; padding: 0 48px; position: relative; transition: box-shadow 0.3s; }
...
.logo { font-family: 'Cormorant Garamond', serif; font-size: 21px; font-weight: 500; letter-spacing: 0.32em; text-transform: uppercase; color: var(--ink); text-decoration: none; }

/* NAV ITEMS */
.nav-item { position: relative; height: var(--nav-h); display: flex; align-items: center; }
.nav-link { font-size: 10.5px; letter-spacing: 0.16em; text-transform: uppercase; color: var(--ink-soft); text-decoration: none; padding: 0 16px; height: 100%; display: flex; align-items: center; cursor: pointer; transition: color 0.22s; white-space: nowrap; font-weight: 400; border: none; background: none; position: relative; }
.nav-link:hover, .nav-item.open .nav-link { color: var(--ink); }
.nav-link::after { content: ''; position: absolute; bottom: 0; left: 16px; right: 16px; height: 1.5px; background: var(--ink); transform: scaleX(0); transform-origin: left; transition: transform 0.3s cubic-bezier(0.4,0,0.2,1); }
.nav-item:hover .nav-link::after, .nav-item.open .nav-link::after { transform: scaleX(1); }

/* ICON BTN */
.icon-btn { width: 40px; height: var(--nav-h); display: flex; align-items: center; justify-content: center; cursor: pointer; color: var(--ink-soft); transition: color 0.2s; text-decoration: none; }
...
.mega-menu { background: var(--white); border-top: 1px solid var(--sand-light); border-bottom: 1px solid var(--sand-light); box-shadow: 0 12px 48px rgba(26,23,20,0.1); opacity: 0; transform: translateY(-8px); transition: opacity 0.28s ease, transform 0.28s ease; pointer-events: none; display: none; }
.mega-menu.active { opacity: 1; transform: translateY(0); pointer-events: all; display: block; }
.mega-inner { max-width: 1280px; margin: 0 auto; padding: 48px 48px 52px; display: grid; }

/* MEGA COLS */
.mega-col { }
.mega-col-title { font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: var(--ink-muted); margin-bottom: 18px; padding-bottom: 10px; border-bottom: 1px solid var(--sand-light); font-weight: 400; }
.mega-col-links { list-style: none; display: flex; flex-direction: column; gap: 10px; }
.mega-col-links a { font-size: 12.5px; letter-spacing: 0.06em; color: var(--ink-soft); text-decoration: none; transition: color 0.2s, padding-left 0.2s; display: block; font-weight: 300; }
.mega-col-links a:hover { color: var(--ink); padding-left: 4px; }
.mega-see-all { display: inline-block; margin-top: 18px; font-size: 10px; letter-spacing: 0.18em; text-transform: uppercase; color: var(--ink-muted); text-decoration: none; border-bottom: 1px solid var(--sand); padding-bottom: 2px; transition: color 0.2s, border-color 0.2s; }
.mega-see-all:hover { color: var(--ink); border-color: var(--ink); }
.mega-accent-box { display: flex; align-items: center; justify-content: center; flex-direction: column; gap: 10px; padding: 32px; }

/* BACKDROP */
.menu-overlay { position: fixed; inset: 0; background: rgba(26,23,20,0.18); backdrop-filter: blur(1px); z-index: 998; opacity: 0; pointer-events: none; transition: opacity 0.28s; }
...
.hero-pattern { position: absolute; inset: 0; background: repeating-linear-gradient(45deg,transparent,transparent 40px,rgba(201,185,154,0.12) 40px,rgba(201,185,154,0.12) 41px),repeating-linear-gradient(-45deg,transparent,transparent 40px,rgba(201,185,154,0.08) 40px,rgba(201,185,154,0.08) 41px); }
.hero-monogram { position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%); font-family: 'Cormorant Garamond', serif; font-size: 260px; font-weight: 300; color: rgba(201,185,154,0.2); line-height: 1; user-select: none; animation: fadeIn 1.2s ease both; }
.hero-label { position: absolute; bottom: 48px; left: 48px; writing-mode: vertical-lr; text-orientation: mixed; transform: rotate(180deg); font-size: 10px; letter-spacing: 0.24em; text-transform: uppercase; color: var(--ink-muted); }
.hero-content { background: var(--white); display: flex; flex-direction: column; justify-content: center; padding: 80px 72px 80px 64px; animation: slideUp 0.9s 0.2s ease both; }
...
.hero-title { font-family: 'Cormorant Garamond', serif; font-size: clamp(40px, 4.5vw, 62px); font-weight: 400; line-height: 1.08; color: var(--ink); margin-bottom: 12px; }
...
.section-title { font-family: 'Cormorant Garamond', serif; font-size: clamp(28px, 3vw, 40px); font-weight: 400; line-height: 1.12; color: var(--ink); }
...
.stat-card { background: var(--white); padding: 32px 28px; transition: background 0.2s; cursor: default; }
...
.stat-label { font-size: 10px; letter-spacing: 0.18em; text-transform: uppercase; color: var(--ink-muted); line-height: 1.4; font-weight: 400; }
...
.marche-card { background: var(--white); padding: 44px 36px; position: relative; overflow: hidden; cursor: default; transition: background 0.25s; }
...
.marche-icon { width: 40px; height: 40px; margin-bottom: 24px; color: var(--sand); }
.marche-icon svg { width: 100%; height: 100%; stroke-width: 1; }
.marche-card-title { font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 400; color: var(--ink); margin-bottom: 14px; }
.marche-card-text { font-size: 13px; line-height: 1.8; color: var(--ink-muted); font-weight: 300; }
.marche-list { list-style: none; margin-top: 16px; display: flex; flex-direction: column; gap: 7px; }
...
.axe-card { background: var(--ink); padding: 52px 40px; position: relative; overflow: hidden; transition: background 0.25s; cursor: default; }
.axe-card:hover { background: #262219; }
.axe-num { font-family: 'Cormorant Garamond', serif; font-size: 80px; font-weight: 300; color: rgba(201,185,154,0.12); line-height: 1; position: absolute; top: 24px; right: 28px; transition: color 0.3s; }
.axe-card:hover .axe-num { color: rgba(201,185,154,0.22); }
.axe-tag { font-size: 10px; letter-spacing: 0.22em; text-transform: uppercase; color: var(--sand); margin-bottom: 18px; display: block; font-weight: 400; }
.axe-title { font-family: 'Cormorant Garamond', serif; font-size: 24px; font-weight: 400; color: var(--cream); margin-bottom: 18px; line-height: 1.2; }
.axe-text { font-size: 13px; line-height: 1.8; color: rgba(245,240,232,0.6); font-weight: 300; }
.axe-list { list-style: none; margin-top: 20px; display: flex; flex-direction: column; gap: 8px; }
...
.plan-phase { padding: 0 32px 48px; text-align: center; }
...
.plan-period { font-size: 10px; letter-spacing: 0.22em; text-transform: uppercase; color: var(--sand); margin-bottom: 12px; font-weight: 400; }
.plan-phase-title { font-family: 'Cormorant Garamond', serif; font-size: 22px; font-weight: 400; color: var(--ink); margin-bottom: 18px; }
.plan-items { list-style: none; text-align: left; display: flex; flex-direction: column; gap: 10px; }
...
/* VISION QUOTE */
.vision-section { background: var(--cream-dark); padding: 120px 0; }
.vision-inner { max-width: 860px; margin: 0 auto; padding: 0 48px; text-align: center; }
.vision-quote { font-family: 'Cormorant Garamond', serif; font-size: clamp(24px, 3.5vw, 40px); font-weight: 300; font-style: italic; line-height: 1.5; color: var(--ink); margin-bottom: 40px; position: relative; padding-top: 20px; }
.vision-quote::before { content: '\201C'; font-size: 120px; color: rgba(201,185,154,0.35); position: absolute; top: -30px; left: -10px; line-height: 1; font-family: 'Cormorant Garamond', serif; }
.vision-divider { width: 40px; height: 1px; background: var(--sand); margin: 20px auto; }
...
.lead-card { background: var(--white); padding: 40px 32px; text-align: center; transition: background 0.25s; cursor: default; }
.lead-card:hover { background: var(--cream-mid); }
.lead-icon { width: 48px; height: 48px; margin: 0 auto 20px; color: var(--sand); }
...
/* CONTACT */
.contact-section { background: var(--cream-dark); padding: 96px 0; }
.contact-inner { max-width: 680px; margin: 0 auto; padding: 0 48px; text-align: center; }
.contact-title { font-family: 'Cormorant Garamond', serif; font-size: 38px; font-weight: 400; color: var(--ink); margin-bottom: 16px; }
.contact-sub { font-size: 14px; color: var(--ink-muted); margin-bottom: 48px; line-height: 1.7; font-weight: 300; }
.contact-info { display: flex; justify-content: center; gap: 48px; flex-wrap: wrap; }
.contact-item-label { font-size: 9.5px; letter-spacing: 0.22em; text-transform: uppercase; color: var(--sand); margin-bottom: 6px; font-weight: 400; }
.contact-item-value { font-size: 14px; color: var(--ink); font-weight: 300; }
.btn-primary { display: inline-block; margin-top: 40px; background: var(--ink); color: var(--cream); font-size: 10.5px; letter-spacing: 0.22em; text-transform: uppercase; padding: 16px 40px; text-decoration: none; font-weight: 400; transition: background 0.25s, letter-spacing 0.3s; }
.btn-primary:hover { background: var(--ink-soft); letter-spacing: 0.28em; }

/* FOOTER */
.footer { background: var(--ink); color: rgba(245,240,232,0.6); padding: 64px 48px 32px; }
.footer-grid { max-width: 1200px; margin: 0 auto; display: grid; grid-template-columns: 1.5fr 1fr 1fr 1fr; gap: 48px; padding-bottom: 48px; border-bottom: 1px solid rgba(201,185,154,0.15); margin-bottom: 32px; }
.footer-logo { font-family: 'Cormorant Garamond', serif; font-size: 20px; font-weight: 500; letter-spacing: 0.28em; color: var(--cream); display: block; margin-bottom: 16px; }
.footer-tagline { font-size: 12px; line-height: 1.7; color: rgba(245,240,232,0.45); font-weight: 300; max-width: 220px; }
.footer-col-title { font-size: 10px; letter-spacing: 0.2em; text-transform: uppercase; color: var(--sand); margin-bottom: 18px; font-weight: 400; }
    ...
    <div class="mega-wrapper">
      ...
      <div class="mega-menu" id="mega-vision">
        <div class="mega-inner" style="grid-template-columns:repeat(3,1fr);gap:0;">
          <div class="mega-col" style="border-right:1px solid var(--sand-light);padding-right:48px;">
            <div class="mega-col-title">Axes principaux</div>
            <ul class="mega-col-links">
              <li><a href="#strategie">Activation de l'écosystème</a></li>
              <li><a href="#strategie">Développement de partenariats</a></li>
              <li><a href="#strategie">Renforcement de la visibilité</a></li>
            </ul>
          </div>
          <div class="mega-col" style="padding-left:48px;border-right:1px solid var(--sand-light);padding-right:48px;">
            <div class="mega-col-title">Segments cibles</div>
            <ul class="mega-col-links">
              <li><a href="#marche">Hospitality & Hôtellerie</a></li>
              <li><a href="#marche">Architectes & Designers</a></li>
              <li><a href="#marche">Retail premium</a></li>
              <li><a href="#marche">Corporate gifting</a></li>
            </ul>
          </div>
          <div class="mega-col" style="padding-left:48px;">
            <div class="mega-col-title">Vision à moyen terme</div>
            <ul class="mega-col-links">
              <li><a href="#vision">Référence hospitality France</a></li>
              <li><a href="#vision">Réseau de prescripteurs</a></li>
              <li><a href="#vision">Présence retail premium</a></li>
            </ul>
            <a href="#strategie" class="mega-see-all">Voir la stratégie complète</a>
          </div>
        </div>
      </div>
      ...
      <div class="mega-menu" id="mega-marche">
        <div class="mega-inner" style="grid-template-columns:220px 1fr 1fr;gap:0 48px;">
          <div style="background:var(--cream-dark);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:10px;padding:32px;">
            <div style="font-family:'Cormorant Garamond',serif;font-size:64px;color:var(--sand);opacity:0.5;line-height:1;">FR</div>
            <div style="font-size:10px;letter-spacing:0.2em;text-transform:uppercase;color:var(--ink-muted);text-align:center;">Marché Français</div>
          </div>
          <div class="mega-col">
            <div class="mega-col-title">Écosystèmes clés</div>
            <ul class="mega-col-links">
              <li><a href="#marche">Gastronomie & Restauration</a></li>
              <li><a href="#marche">Hôtellerie de luxe</a></li>
              <li><a href="#marche">Architecture & Design</a></li>
              <li><a href="#marche">Lifestyle premium</a></li>
            </ul>
          </div>
          <div class="mega-col">
            <div class="mega-col-title">Réseaux prioritaires</div>
            <ul class="mega-col-links">
              <li><a href="#marche">Architectes d'intérieur</a></li>
              <li><a href="#marche">Groupes hôteliers</a></li>
              <li><a href="#marche">Concept stores design</a></li>
              <li><a href="#marche">Promoteurs immobiliers</a></li>
              <li><a href="#marche">Environnements corporate</a></li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div class="mega-menu" id="mega-plan">
        <div class="mega-inner" style="grid-template-columns:repeat(3,1fr);gap:0;">
          <div class="mega-col" style="border-right:1px solid var(--sand-light);padding-right:48px;">
            ...
            <ul class="mega-col-links">
              <li><a href="#plan">Phase d'écoute</a></li>
              <li><a href="#plan">Analyse de l'équipe</a></li>
              <li><a href="#plan">Comptes clés existants</a></li>
              <li><a href="#plan">Audit distribution & partenaires</a></li>
            </ul>
          </div>
          <div class="mega-col" style="padding-left:48px;border-right:1px solid var(--sand-light);padding-right:48px;">
            <div class="mega-col-title">30 – 60 jours</div>
            <ul class="mega-col-links">
              <li><a href="#plan">Identification des priorités</a></li>
              <li><a href="#plan">Sélection des comptes stratégiques</a></li>
              <li><a href="#plan">Activation des quick wins</a></li>
            </ul>
          </div>
          <div class="mega-col" style="padding-left:48px;">
            <div class="mega-col-title">60 – 90 jours</div>
            <ul class="mega-col-links">
              <li><a href="#plan">Feuille de route structurée</a></li>
              <li><a href="#plan">Lancement des initiatives</a></li>
              <li><a href="#plan">KPIs & objectifs</a></li>
            </ul>
            <a href="#plan" class="mega-see-all">Voir le plan complet</a>
          </div>
        </div>
      </div>
      ...
      <div class="mega-menu" id="mega-profil">
        <div class="mega-inner" style="grid-template-columns:220px 1fr 1fr;gap:0 48px;">
          <div style="background:var(--cream-dark);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:10px;padding:32px;">
            <div style="font-family:'Cormorant Garamond',serif;font-size:56px;color:var(--sand);font-weight:300;line-height:1;">20+</div>
            <div style="width:32px;height:1px;background:var(--sand);"></div>
            <div style="font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:var(--ink-muted);text-align:center;line-height:1.6;">Années d'expérience<br>B2B</div>
          </div>
          <div class="mega-col">
            <div class="mega-col-title">Expériences</div>
            <ul class="mega-col-links">
              <li><a href="#profil">Management d'équipes commerciales</a></li>
              <li><a href="#profil">Pilotage de P&L</a></li>
              <li><a href="#profil">Comptes stratégiques</a></li>
              <li><a href="#profil">Distribution mobilier premium</a></li>
            </ul>
          </div>
          <div class="mega-col">
            <div class="mega-col-title">Atouts clés</div>
            <ul class="mega-col-links">
              <li><a href="#profil">Structuration de marchés</a></li>
              <li><a href="#profil">Activation d'écosystèmes</a></li>
              <li><a href="#profil">Environnements premium</a></li>
              <li><a href="#profil">Réseau prescripteurs</a></li>
            </ul>
            <a href="#profil" class="mega-see-all">Voir le profil complet</a>
          </div>
        </div>
      </div>
      ...
      <div class="mega-menu" id="mega-apropos">
        <div class="mega-inner" style="grid-template-columns:220px 1fr 1fr;gap:0 48px;">
          <div style="background:var(--ink);display:flex;align-items:center;justify-content:center;flex-direction:column;gap:12px;padding:32px;">
            <div style="font-family:'Cormorant Garamond',serif;font-size:28px;color:var(--cream);font-weight:400;letter-spacing:0.06em;text-align:center;line-height:1.3;">Terence<br>Richard</div>
            <div style="width:32px;height:1px;background:var(--sand);"></div>
            <div style="font-size:10px;letter-spacing:0.18em;text-transform:uppercase;color:var(--sand);">Dir. Commercial</div>
          </div>
          <div class="mega-col">
            ...
            <ul class="mega-col-links">
              ...
              <li><a href="#strategie">Vision stratégique</a></li>
          ...
          <div class="mega-col">
            ...
            <a href="#contact" class="mega-see-all">Prendre contact</a>
          </div>
        </div>
      </div>
...
<section class="hero" id="hero">
  ...
  <div class="hero-content">
    ...
    <p class="hero-intro">
      Serax occupe une position unique à l'intersection du design, de l'hospitality et du lifestyle premium. La France représente l'un des marchés les plus influents en Europe — un écosystème riche à structurer et à activer durablement.
    </p>
    <a href="#profil" class="hero-cta">
      Découvrir la vision
      ...
      <div>
        <div class="stats-grid">
          <div class="stat-card">
            ...
            <div class="stat-label">Années d'expérience B2B</div>
          </div>
          <div class="stat-card">
            <div class="stat-num">3</div>
            <div class="stat-label">Axes stratégiques pour la France</div>
          </div>
          <div class="stat-card">
            <div class="stat-num">90</div>
            <div class="stat-label">Jours pour un plan concret</div>
          </div>
          <div class="stat-card">
            <div class="stat-num">5</div>
            <div class="stat-label">Segments marché à activer</div>
          </div>
        </div>
      </div>
    </div>
...
<section class="section marche-section" id="marche">
  <div class="section-inner">
    ...
    <div class="marche-grid reveal">
      ...
      <div class="marche-card">
        <div class="marche-icon">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 000 20 14.5 14.5 0 000-20"/><line x1="2" y1="12" x2="22" y2="12"/></svg>
        </div>
      ...
      <div class="marche-card">
        ...
        <ul class="marche-list">
          ...
          <li>Corners dédiés en enseignes premium</li>
        </ul>
      </div>
    </div>
  </div>
  ...
  <div class="section-inner">
    ...
    <div class="axes-grid reveal">
      <div class="axe-card">
        ...
        <div class="axe-text">Identifier et activer tous les acteurs clés du marché français autour de la marque Serax.</div>
        <ul class="axe-list">
      ...
      <div class="axe-card">
        ...
        <div class="axe-text">Construire des partenariats durables et structurants avec les acteurs premium du marché.</div>
        <ul class="axe-list">
